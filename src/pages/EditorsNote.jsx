                ...
                <Container className="min-h-screen grid__container">
                  ...
                  <Row>
                    ...
                    <Col lg={4} md={6} sm={12} xs={12}>
                      ...
                      >
                        As Britain and China negotiated the Handover, two
                        promises were woven into the constitution to &ldquo;ease
                        the hearts&rdquo; of Hong&nbsp;Kong people. The first
                        was the &ldquo;one country, two systems&rdquo;
                        principle, an arrangement that would honour the
                        region&rsquo;s unique way of life for fifty years, thus
                        easing the transition back to the motherland. The second
                        was the &ldquo;ultimate aim&rdquo; of universal
                        suffrage, which would grant Hong&nbsp;Kong people the
                        opportunity to govern their own region in the future.
                      </p>
                      <br />
                      <p
                        className={`medium-body text-white text-opacity-75 fade-second`}
                      ...
                      >
                        ...
                        held symbolic meaning for a new generation of
                      ...
                      >
                        To tell the story of Hong Kong with accuracy and care,
                        the project is compiled into several layers. On the
                        surface, it provides a historical account of
                        Hong&nbsp;Kong&rsquo;s handover since the Sino-Joint
                        Declaration was signed in 1984. Beneath that lies an
                        archive of digital artifacts—a collection of stories,
                        imagery, and musings that capture how people felt as
                        their history unfolded. At its core, this project is an
                        anthology of reflections that attempts to forge meaning
                        from the tragic events that have transpired. It invites
                        questions. What does it mean to be a Hongkonger? Can
                        freedom survive in the absence of democracy? What role
                        does collective memory play in cultivating identity?
                      </p>
                      <br />
                      <p
                        className={`medium-body text-white text-opacity-75 fade-second`}
                      ...
                      >
                        On a more personal note, this project has provided us,
                        the editors and curators, an opportunity to explore our
                        personal histories and sense of belonging. It has given
                        us the space to examine how our lineage is woven into
                        our identities, and has provided us a glimpse of the
                        modest role we play within a larger narrative that
                      ...
                      >
                        ...
                        sense — on borrowed time. As the region&rsquo;s fifty
                        year period of grace slowly ends, the CCP&rsquo;s
                        encroaching influence and presence have grown larger,
                        and the promises that were once made to Hong&nbsp;Kong
                        are now under threat. New legislation, such as the
                        National Security Law, has been weaponised to silence
                        pro-democracy advocates, and has forever reshaped what
                        can be said and fought for in Hong&nbsp;Kong.
                      </p>
                      <br />
                      <p
                      ...
                      >
                        It is within this historical context that On Borrowed
                        Time was created. The project contributes to the shared
                        endeavour of documenting Hong&nbsp;Kong&rsquo;s unique
                        status in the face of censorship. While some may believe
                        that Hong&nbsp;Kong&rsquo;s impermanence is inevitable,
                        it is through preserving the collective memory of
