        ...
        <Container className="min-h-screen grid__container">
          <Row className={`grid__row intro-paragraph pb-16`}>
            ...
            <Col lg={10} md={8} sm={12} xs={12}>
              ...
              >
                ...
                Hong&nbsp;Kong&apos;s perpetual impermanence. The
                region&apos;s intertwining history can be understood as the product of two forces — a colonial legacy that it struggles to reconcile itself with, and an authoritarian future fraught with uncertainty.
              </p>
            </Col>
            <Col lg={1} md={2} />
          </Row>
          <Row>
            ...
            <Col lg={4} md={6} sm={12} xs={12}>
              ...
              >
                As Britain and China negotiated the Handover, two promises were woven into the constitution to &ldquo;ease the hearts&rdquo; of Hong&nbsp;Kong people. The first was the &ldquo;one country, two systems&rdquo; principle, an arrangement that would honour the region&apos;s unique way of life for fifty years, thus easing the transition back to the motherland. The second was the &ldquo;ultimate aim&rdquo; of universal suffrage, which would grant Hong&nbsp;Kong people the opportunity to govern their own region in the future.
              </p>
              <br />
              <p
                className={`medium-body text-white text-opacity-75 fade-second`}
              ...
              >
               Beyond the constitutional details, these two promises held symbolic meaning for a new generation of Hongkongers. They inspired the hope that the region could someday dictate its own future. Throughout Hong&nbsp;Kong&apos;s conflicting history, the region has never had the opportunity to experience democratic qualities like self-determination, universal suffrage, or genuine democracy. It has always been beholden to forces larger than itself.
              </p>
              <br />
              <p
                className={`medium-body text-white text-opacity-75 fade-second`}
