            ...
            <Row id="scroll-container" className="grid__row modal-height">
              ...
              {excerptTypes.includes(type) && (
                <>
                  <>
                    <Hidden xs sm>
                      <Col lg={2} md={2} sm={0} xs={0} onClick={onClickSpan} />
                    </Hidden>
                    <Col lg={1} md={2} sm={1} xs={1} />
                    <Col lg={7} md={7} sm={10} xs={10} className="pt-8">
              ...
              {type === 'Imagery' && (
                <>
                  <Hidden xs sm>
                    <Col lg={4} md={2} sm={0} xs={0} onClick={onClickSpan} />
                  </Hidden>
                  <Col lg={1} md={2} sm={1} xs={1} />
                  <Col lg={6} md={7} sm={10} xs={10} className="pt-8">
                    <div className="bg-white z-30 pt-8 anecdote-fixed-header">
                      <div className="small-body text-gray-90 mb-8">
                        {shortTitle !== title ? parse(shortTitle) : ''}
                      </div>
              ...
              {poemTypes.includes(type) && (
                <>
                  <Hidden xs sm>
                    <Col lg={6} md={2} sm={0} xs={0} onClick={onClickSpan} />
                  </Hidden>
                  <Col lg={1} md={2} sm={1} xs={1} />
                  <Col lg={5} md={7} sm={10} xs={10}>
                    <div className="bg-white z-30 pt-8 anecdote-fixed-header">
